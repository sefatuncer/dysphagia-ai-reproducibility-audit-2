...
meta-research audit "Available but not executable: auditing the execution prerequisites of shared
code in dysphagia and swallowing artificial-intelligence studies."*
...
**Research questions:** RQ1 transparency proportions (license, weights in-repo/anywhere, environment, sample data, run instructions) among code-available repositories; RQ2 out-of-the-box re-executability in a clean CPU container + barrier taxonomy; RQ3 reference-standard validity, label quality and spectrum (RS1–RS6). [Corrected 2026-08-18: this line previously read “clinical reproducibility”. The manuscript explicitly declines that term, which would blur label-measurement reliability and validity; the wording is corrected here and the earlier phrasing is quoted rather than deleted.]

**Study design:** Meta-research **re-execution study** (NOT a systematic review; no PRISMA-ScR claim). No human participants and no newly collected data. [Corrected 2026-08-18: this line previously read “ethics-exempt”. No exemption was sought or granted; the manuscript states that we made no ethics submission and no formal non-human-subjects determination, and this document is corrected to match.]
